...
Python 使用缩进（行首的空格）来分隔代码块。根据程序的逻辑，缩进可能是强制性的。如您所见，if 中的语句应该缩进。

if 语句中表达式末尾的冒号很重要，不要省略。
...
https://www.runoob.com/python3/python3-basic-operators.html#ysf4
